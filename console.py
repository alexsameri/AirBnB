#!/usr/bin/python3
"""Module for the entry point of the command interprete"""
import cmd
...
class HBNBCommand(cmd.Cmd):
    ...
    def do_EOF(self, line):
        """Handles end of the file character"""
        print()
        return True
    ...
    def do_all(self, line):
        """prints all string represetation of all instances or not on the class name"""
        if line != "":
            words = line.split(' ')
            if words[0] not in storage.classes():
                print("** no instance found **")
